# Counter operated unicycle - CuO license (V1.0.0)

`(c) [year] [username/name]
all rights reserved
|
(for the public domain, all rights (solely granted by this license) shall be reserved for the owner)
|
 [using this license may affect the coprygight holder from the original use
|
